...
afro.data <- dplyr::select(afro.data, RESPNO, COUNTRY, REGION, DATEINTR, STRTIME, Q1, Q36, Q43A, Q43B, Q43D, Q43F, Q58A, Q58B, Q58C, Q101, Q104)
names(afro.data) <- c("respno", "country", "region", "day", "time", "age", "democr", "trst_pres", "trst_parl", "trst_local", "trst_opposition", "perf_pres", "perf_parl", "perf_local", "female", "housing")
head(afro.data)
...
```{r}
###save as csv file
write.csv(sample,"afro-sample.csv", row.names = F)
